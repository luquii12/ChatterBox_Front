...
const PruebaImgUsuario = () => {
  ...
  useEffect(() => {
    ...
    axios
      .get(
        `https://localhost:8443/usuarios/${usuario.id_usuario}/foto-perfil`,
        {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const res = await axios.put(
        `https://localhost:8443/usuarios/${usuario.id_usuario}`,
        formData,
        axiosConfig
      );
...
export default PruebaImgUsuario;
